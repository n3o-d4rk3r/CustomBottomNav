...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int spaceNavigationHeight = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.space_navigation_height);
    private final int mainContentHeight = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.main_content_height);
    private final int centreContentWight = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.centre_content_width);
    private final int itemContentWight = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.item_content_width);
    private final int centreButtonSize = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.space_centre_button_default_size);
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView);
            spaceItemIconSize = typedArray.getDimensionPixelSize(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_space_item_icon_size, resources.getDimensionPixelSize(bd.com.qably.custombottomnav.R.dimen.space_item_icon_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(bd.com.qably.custombottomnav.R.dimen.space_item_icon_only_size));
            spaceItemTextSize = typedArray.getDimensionPixelSize(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_space_item_text_size, resources.getDimensionPixelSize(bd.com.qably.custombottomnav.R.dimen.space_item_text_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(bd.com.qably.custombottomnav.R.dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_space_background_color, resources.getColor(bd.com.qably.custombottomnav.R.color.space_default_color));
            centreButtonColor = typedArray.getColor(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_centre_button_color, resources.getColor(bd.com.qably.custombottomnav.R.color.centre_button_color));
            activeSpaceItemColor = typedArray.getColor(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_active_item_color, resources.getColor(bd.com.qably.custombottomnav.R.color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(bd.com.qably.custombottomnav.R.styleable.SpaceNavigationView_inactive_item_color, resources.getColor(bd.com.qably.custombottomnav.R.color.default_inactive_item_color));
            ...
            inActiveCentreButtonIconColor = typedArray.getColor(R.styleable.SpaceNavigationView_inactive_centre_button_icon_color, resources.getColor(bd.com.qably.custombottomnav.R.color.default_inactive_item_color));
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.SpaceNavigationView_active_centre_button_background_color, resources.getColor(bd.com.qably.custombottomnav.R.color.centre_button_color));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (spaceBackgroundColor == NOT_DEFINED)
            spaceBackgroundColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.space_default_color);

        if (centreButtonColor == NOT_DEFINED)
            centreButtonColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.centre_button_color);

        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.near_me;

        if (activeSpaceItemColor == NOT_DEFINED)
            activeSpaceItemColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.space_white);

        if (inActiveSpaceItemColor == NOT_DEFINED)
            inActiveSpaceItemColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.default_inactive_item_color);

        if (spaceItemTextSize == NOT_DEFINED)
            spaceItemTextSize = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.space_item_text_default_size);

        if (spaceItemIconSize == NOT_DEFINED)
            spaceItemIconSize = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.space_item_icon_default_size);

        if (spaceItemIconOnlySize == NOT_DEFINED)
            spaceItemIconOnlySize = (int) getResources().getDimension(bd.com.qably.custombottomnav.R.dimen.space_item_icon_only_size);

        if (centreButtonRippleColor == NOT_DEFINED)
            centreButtonRippleColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.colorBackgroundHighlightWhite);
        ...
        if (inActiveCentreButtonIconColor == NOT_DEFINED)
            inActiveCentreButtonIconColor = ContextCompat.getColor(context, bd.com.qably.custombottomnav.R.color.default_inactive_item_color);
